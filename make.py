...
try:
	...
	print("goil -t=cortex/armv7em/stm32f303/coroLabBoard --templates=/opt/trampoline/goil/templates lab1.oil")
	sys.exit(1)
...
oilCompiler = "goil"
oilFlags = ["-t=cortex/armv7em/stm32f303/coroLabBoard", "--templates=/opt/trampoline/goil/templates"]
